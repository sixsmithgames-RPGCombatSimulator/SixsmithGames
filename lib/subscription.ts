...
export const PLANS: Record<string, PlanInfo> = {
  bundle: {
    ...
    stripePriceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_BUNDLE || 'price_1TzKNfGeOb0qevnhHBShI39Z',
  },
  'ai-features': {
    id: 'ai-features',
    ...
    stripePriceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_CONTENTCRAFT || 'price_1TzKNcGeOb0qevnh9soNRr9x',
  },
  'virtual-combat-simulator': {
    ...
    stripePriceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_VCS || 'price_1TzKNeGeOb0qevnhmMCsn1EV',
  },
  //gravity: {
  //  id: 'gravity',
  //  name: 'Gravity',
  //  price: 2,
  //  apps: ['gravity'],
  //  stripePriceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_GRAVITY || 'price_1TzKNiGeOb0qevnhCDzRltNM',
  //},
  fourstargeneral: {
    id: 'fourstargeneral',
    ...
    stripePriceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_FSG || 'price_1TzKNhGeOb0qevnhw1Q0LIY9',
  },
  mastertyping: {
    id: 'mastertyping',
    name: 'MasterTyping',
    ...
    apps: ['mastertyping'],
    stripePriceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_MASTERTYPING || 'price_1TzKNjGeOb0qevnhcWeHDaXq',
  },
};
