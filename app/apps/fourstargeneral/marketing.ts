...
export const fourStarGeneralProductDefinition: ProductDefinition = {
  ...
  supportingArticleSlugs: [
    ...
    'skill-based-tactics-in-a-wwii-strategy-game',
  ...
  howItWorks: [
    ...
    'Resolve tactical outcomes through visible rules, so the battle reflects the decisions that led into it.',
  ...
  faq: [
    ...
    {
      question: 'What does skill-based tactics mean in Four Star General?',
      answer:
  ...
  gettingStarted: [
    ...
    'Launch the browser build and start with the tactical battle layer so you can learn how deployment, objectives, and visible tactical resolution fit together.',
  ...
  commonUseCases: [
    ...
    'Comparing tactical approaches across repeat runs because the rules always work the same way.',
  ...
  scopeNotes: [
    ...
    'Current scope is tactical battle play with authored scenarios, deployment, reserve management, and visible tactical resolution.',
