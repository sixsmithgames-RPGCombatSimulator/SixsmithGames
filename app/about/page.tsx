        ...
        <div style={{ maxWidth: '1080px', margin: '0 auto', padding: `0 ${pageGutter}` }}>
          ...
          <article style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '22px', padding: cardPadding, boxShadow: '0 24px 60px rgba(0,0,0,0.35)' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', fontSize: '1.05rem', lineHeight: 1.8, color: 'rgba(229,231,235,0.9)' }}>
              ...
              <p>
                That is why the public product lineup looks the way it does. Virtual Combat Simulator is built for people who want cleaner tactical control at the table. ContentCraft is the premium creative platform for projects that need structure, continuity, and built-in AI help without losing control of the work. Four Star General is for players who want real tactical pressure rather than chaos. MasterTyping is for people who want to get better at a real digital skill in a way that feels usable and engaging.
              </p>
              <p>
