    ...
    <div style={{ background: '#f8f9fa' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 50%, #f093fb 100%)', padding: '80px 0', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 2rem', position: 'relative', zIndex: 2, textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 'clamp(1.1rem, 2.5vw, 1.375rem)', color: 'rgba(255,255,255,0.92)', margin: 0 }}>
            Start with the lane that matches how you play: run the table, build the world, or jump into strategy and unlock more depth over time.
          </p>
        </div>
      </section>
        ...
        <div style={{
          ...
          <div style={{ flex: '1 1 340px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.15)', borderRadius: '999px', padding: '0.3rem 1rem', marginBottom: '1rem' }}>
              <span style={{ fontSize: '0.8rem', fontWeight: '700', color: '#fde68a', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Best place to start</span>
            </div>
              ...
              <div style={{ padding: '1.5rem 1.75rem', display: 'flex', flexDirection: 'column', gap: '1rem', flex: 1 }}>
                ...
                {'trial' in plan && plan.trial ? (
                  <div style={{ background: '#f8fafc', borderRadius: '14px', padding: '1rem', border: '1px solid #e5e7eb' }}>
                    <div style={{ fontSize: '0.9rem', fontWeight: 800, color: '#111827', marginBottom: '0.625rem' }}>Start here with</div>
                ...
                {'freePlan' in plan && plan.freePlan ? (
                  <div style={{ background: '#f8fafc', borderRadius: '14px', padding: '1rem', border: '1px solid #e5e7eb' }}>
                    <div style={{ fontSize: '0.9rem', fontWeight: 800, color: '#111827', marginBottom: '0.625rem' }}>Start free with</div>
                    <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                <SubscribeButton planId={plan.slug} style={{ background: plan.gradient, color: 'white', padding: '0.875rem 1.5rem', borderRadius: '12px', fontSize: '1rem', fontWeight: '700', border: 'none', cursor: 'pointer', boxShadow: '0 4px 14px rgba(0,0,0,0.18)', width: '100%' }}>
                  {plan.slug === 'contentcraft' ? `Start Creator Plan — $${plan.price.toFixed(2)}/mo` : `Unlock GM Tools — $${plan.price.toFixed(2)}/mo`}
                </SubscribeButton>
              </div>
            </div>
          ))}
              ...
              <div style={{ padding: '1.5rem 1.75rem', display: 'flex', flexDirection: 'column', gap: '1rem', flex: 1 }}>
                ...
                {'freeCore' in plan && plan.freeCore ? (
                  <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '1rem' }}>
                    <div style={{ fontSize: '0.95rem', fontWeight: 900, color: '#111827', marginBottom: '0.625rem', letterSpacing: '0.01em' }}>In your free loadout</div>
                    <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                {'monetization' in plan && plan.monetization ? (
                  <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '1rem' }}>
                    <div style={{ fontSize: '0.95rem', fontWeight: 900, color: '#111827', marginBottom: '0.625rem', letterSpacing: '0.01em' }}>Unlock deeper play</div>
                    <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
      ...
      <section style={{ padding: '20px 2rem 50px', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: '#6b7280', fontSize: '1.0625rem', margin: 0 }}>
            If you already know your lane, these are the cleanest ways to go all in.
          </p>
        </div>
      ...
      <section style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', padding: '80px 2rem', textAlign: 'center' }}>
        <h2 style={{ color: 'white', fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', fontWeight: '800', margin: '0 0 1rem', textShadow: '0 2px 12px rgba(0,0,0,0.2)' }}>
          Start free. Go deeper when you want.
        </h2>
        <p style={{ color: 'rgba(255,255,255,0.88)', fontSize: '1.125rem', margin: '0 0 2rem', maxWidth: '860px', marginInline: 'auto' }}>
          Run the table, build your world, or jump into strategy with a clear starting point now and more depth whenever you are ready for it.
        </p>
        <Link href="/#apps" style={{ background: 'white', color: '#4c1d95', padding: '1.125rem 3rem', borderRadius: '50px', fontSize: '1.125rem', fontWeight: '800', textDecoration: 'none', boxShadow: '0 8px 30px rgba(0,0,0,0.25)', display: 'inline-block' }}>
          Explore the Lineup
        </Link>
      </section>
    </div>
